...
const ProfileContainer = () => {
  ...
  return (
    <div className='HeaderArea-dark' >
        ...
        <Heading margin={-5} className="mainHeading">Akshay Srivastava</Heading>
        ...
        <Box marginLeft='-8%'>
          <Image src='https://avatars.githubusercontent.com/u/76969329?v=4' alt='Akshay Srivastava' className='photo_image' size={['sm', 'md', 'lg', '4xl']}/>
        </Box>
