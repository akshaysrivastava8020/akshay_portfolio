...
const About = () => {
  ...
  return (
    <Box className="About_style-dark" > 
        ...
        <Box>
        <Text>
        Hello! My name is Akshay Srivastava & I enjoy creating things that live on the internet. I'm a passionate Developer, with strong administrative & communication skills, good attention to detail & the ability to write efficient code.
        </Text>
        <Text>
