...
const About = () => {
  return (
    <Box className="About_style-dark">
      <Heading
        ml={{ base: "5%", md: "10%", lg: "50%" }}
        as="h1"
        width="13%"
        marginLeft="10%"
        borderBottom="4px solid #a1a1a1"
        mt="0px"
      >
        About Me
      </Heading>
      <Box className="About_box" data-aos="fade-up">
        <Box>
          <Text>
            Hello! My name is Akshay Srivastava & I enjoy creating things that
          ...
          <Text>
            My field of interest is building new Web Technologies and also in
            areas related to Deep Learning and Natural Language Processing.
          </Text>
          <Text>
            ...
            have work experience in multiple projects and clone projects with
            team collaboration.
          </Text>
        </Box>
      </Box>
